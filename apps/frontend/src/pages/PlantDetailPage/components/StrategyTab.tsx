  ...
  return (
    <div className="space-y-4 relative">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {/* Hidden refresh button - Use admin API to force refresh */}
        <button
          onClick={onRefresh}
          disabled={refreshing}
          className="hidden flex items-center gap-2 px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          <RefreshCwIcon
            size={16}
